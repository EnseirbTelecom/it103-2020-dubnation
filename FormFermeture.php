...
<p>
    ...
    <input type="submit" name="remboursement" value="Fermer ces transactions par remboursement"/><input type="submit" name ="annulation" value="Fermer ces transactions par annulation">
