...
if (isset($_POST["annulation"])){
  ...
  if (isset($_POST["Tr1"]) && ($_POST["Tr1"]>0)){
    $Tr1=$_POST["Tr1"];
    //echo $Tr1;
    AnnulTrans($link,$Tr1,$Mf);
  }

  if (isset($_POST["Tr2"]) && ($_POST["Tr2"]>0)){
    $Tr2=$_POST["Tr2"];
    //echo $Tr2;
    AnnulTrans($link,$Tr2,$Mf);
  }

  if (isset($_POST["Tr3"]) && ($_POST["Tr3"]>0)){
    $Tr3=$_POST["Tr3"];
    //echo $Tr3;
    AnnulTrans($link,$Tr3,$Mf);
  }

  if (isset($_POST["Tr4"]) && ($_POST["Tr4"]>0)){
    $Tr4=$_POST["Tr4"];
    //echo $Tr4;
    AnnulTrans($link,$Tr4,$Mf);
  }

  if (isset($_POST["Tr5"]) && ($_POST["Tr5"]>0)){
    $Tr5=$_POST["Tr5"];
    //echo $Tr5;
    AnnulTrans($link,$Tr5,$Mf);
  }
